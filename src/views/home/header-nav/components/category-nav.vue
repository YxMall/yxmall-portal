        ...
        <ul class="nav-wrap">
          <li v-for="navItem in navItems"
            ...
            <a href="javascript: void(0);"
               @mouseenter="isEnter(navItem.type)">{{navItem.name}}</a>
          </li>
        </ul>
      </div>
      <icon-svg name='admin' />
      <div class="header-search">
        ...
        <div class="search-result">
          <ul class="result-wrap">
            <li v-for="resultItem in resultItems"
                :key='resultItem.id'
                class="item">
      ...
      <div class="header-menu"
        ...
        <ul class="menus">
          <li class="product"
            ...
            <p class="info"
               v-show="tabItem.showStatus"><span class="flag">{{tabItem.info}}</span></p>
            <a :href="tabItem.link"><img :src="tabItem.imgUrl"
                   :alt="tabItem.name"></a>
...
@font-face {
    ...
    src: url('//at.alicdn.com/t/font_xqxs22iapl9885mi.eot?#iefix')
        ...
        url('//at.alicdn.com/t/font_xqxs22iapl9885mi.svg#iconfont')
            format('svg');
}
#top-header {
    width: 100%;
    ...
    > .container {
        ...
        > .logo {
            width: 55px;
            height: 55px;
            background: url('https://s01.mifile.cn/i/logo-footer.png?v2')
                no-repeat 50% 50% #ff6700;
        }
        > .pic-gif {
            width: 163px;
            height: 66px;
            margin-left: 10px;
            background: url('http://i1.bvimg.com/668714/8dd3d14f893035da.gif')
                no-repeat 50% 50%;
        }
        > .header-nav {
            position: relative;
